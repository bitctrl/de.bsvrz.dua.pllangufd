...
implements IBmListener{
	...
	throws Exception{
		return new String[]{"Der Wert " + UmfeldDatenArt.getUmfeldDatenArtVon(this.getPruefling()).toString() + //$NON-NLS-1$ 
				" für die Messstelle ufdMessSt.pruefling (ufdMessSt.pruefling)" + //$NON-NLS-1$
				...
				" für die Messstelle ufdMessSt.pruefling (ufdMessSt.pruefling) konnte nicht durchgeführt werden," + //$NON-NLS-1$
