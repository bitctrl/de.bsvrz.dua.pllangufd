...
implements IBmListener{
	...
	throws Exception{
		return new String[]{"Der Wert " + UmfeldDatenArt.getUmfeldDatenArtVon(this.getPruefling()).toString() + //$NON-NLS-1$
				" für die Messstelle ufdMessSt.pruefling (ufdMessSt.pruefling) weicht um 00:22:30 (>00:15:00)" + //$NON-NLS-1$
		...
		"Der Wert " + UmfeldDatenArt.getUmfeldDatenArtVon(this.getPruefling()).toString() + //$NON-NLS-1$
				" für die Messstelle ufdMessSt.pruefling (ufdMessSt.pruefling) weicht um 00:30:00 (>00:15:00)" + //$NON-NLS-1$
